...
Zbiór danych który będziemy wykorzystywać to \url{https://www.kaggle.com/c/forest-cover-type-prediction/data} zawarte są w nim dane dotyczącę terenów i na ich podstawie będziemy oceniać jaki typ lasu rośnie na danym terenie.
